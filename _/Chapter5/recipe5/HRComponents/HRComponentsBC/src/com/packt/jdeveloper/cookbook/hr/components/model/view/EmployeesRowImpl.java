...
public class EmployeesRowImpl extends ExtViewRowImpl {
    ...
    public static final int COLORSLOV = AttributesEnum.ColorsLov.index();
    ...
    /**
     * Gets the view accessor <code>RowSet</code> ColorsLov.
     */
    public RowSet getColorsLov() {
        return (RowSet)getAttributeInternal(COLORSLOV);
    }
