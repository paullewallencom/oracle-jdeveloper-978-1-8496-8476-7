...
public class EmployeesRowImpl extends ExtViewRowImpl {
    ...
    public static final int HRSHAREDCOMPONENTSAPPMODULE_COLORSLOV = AttributesEnum.HrSharedComponentsAppModule_ColorsLov.index();
    public static final int HRSHAREDCOMPONENTSAPPMODULE_COUNTRIESLOV = AttributesEnum.HrSharedComponentsAppModule_CountriesLov.index();
    public static final int HRSHAREDCOMPONENTSAPPMODULE_DEPARTMENTSLOV = AttributesEnum.HrSharedComponentsAppModule_DepartmentsLov.index();
    public static final int HRSHAREDCOMPONENTSAPPMODULE_JOBSLOV = AttributesEnum.HrSharedComponentsAppModule_JobsLov.index();
