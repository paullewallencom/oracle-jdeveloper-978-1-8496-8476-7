...
public class EmployeeImpl extends ExtEntityImpl {
    ...
    public static final int DEPARTMENTSMANAGED =
        AttributesEnum.DepartmentsManaged.index();
    public static final int EMPLOYEEDEPARTMENT =
        AttributesEnum.EmployeeDepartment.index();
    public static final int EMPLOYEESMANAGED =
        AttributesEnum.EmployeesManaged.index();
    public static final int EMPLOYEEMANAGER =
        AttributesEnum.EmployeeManager.index();
    public static final int EMPLOYEECOUNT =
        AttributesEnum.EmployeeCount.index();
